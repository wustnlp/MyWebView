...
import wust.com.mywebview.arouter.testinject.TestObj;
import wust.com.mywebview.arouter.testinject.TestParcelable;
import wust.com.mywebview.arouter.testservice.HelloService;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.failNav2:
                ...
                break;
            case R.id.failNav3:
                ARouter.getInstance().navigation(Main2Activity.class);
                break;
